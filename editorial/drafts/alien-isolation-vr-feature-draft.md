...
A modder named JayP released GRAND-MotherVR, built on MotherVR's foundation but fundamentally transformed. True six-degrees-of-freedom motion controls. Hand models that track your movements. Body presence—arms, hands, the physicality of occupying Amanda Ripley's space. The mod doesn't just enable VR; it reimagine how the game plays in it.
...
- Steam version of Alien: Isolation (GOG and Epic not yet supported)
- Windows 10 or 11
- SteamVR or Meta/Oculus Link compatible headset
- MotherVR installed as a prerequisite, then GRAND-MotherVR added via single DLL

**Performance Expectations:**
- Modest hardware can run the base game, but VR rendering demands significantly more
- Mid-range systems (modern mid-tier GPU, 16GB RAM) should handle the experience well with balanced settings
- High-end systems can take advantage of supersampling and full graphical options
