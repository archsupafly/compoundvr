...
supportStatus: Active (community mod)
genres:
...
**Game Quality: A**
Team Fortress 2 remains one of the best class-based multiplayer shooters ever made — distinctive, deep, and endlessly replayable. A genuine classic that's maintained an active community for good reason.

**VR Implementation Quality: F (official) / C (Virtual Fortress 2)**
The official VR mode is abandonware — broken for modern headsets, providing only head tracking with keyboard/mouse input. Virtual Fortress 2 shows real promise with proper motion controls, but it's single-player exploration only and incomplete. Neither delivers playable TF2.
