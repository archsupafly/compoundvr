...
- UploadVR review (2016) — core gameplay, VR vs flat experience, atmosphere
- Eurogamer review (2016) — game design, difficulty, aesthetic
- IGN review (2016) — boss design, controls, mechanics depth
- TheSixthAxis PSVR2 review (2023) — platform comparison, visual/audio enhancement
- Meta Quest store page — platform availability
- OpenCritic review aggregation — overall critical reception

---

## Testing Notes

Not directly tested. Article based on editorial research and published reviews. All claims derived from verified sources above.