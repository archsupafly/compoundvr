...
|-------|----------|-----------------|------------------|------|----------|
| **3dSen VR** | PCVR | Voxel diorama | Easy | $24.99 | Definitive Metroid VR experience |
| **3dSen VR MR** | Quest | Mixed reality diorama | Easy | $24.99 | Atmospheric tabletop exploration |
...
|--------|--------------|---------------------|
| Move | D-Pad | Left Stick or D-Pad |
| Jump | A | A Button |
| Shoot | B | B Button or Right Trigger |
| Morph Ball | Down | Down on D-Pad or Left Stick |
| Select Weapon | Select | Select or Back |
