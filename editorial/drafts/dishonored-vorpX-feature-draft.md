...
**Status:** Draft  
**Type:** Feature Article — Injection Driver Experience  
**Game:** Dishonored (2012)  
**VR Route:** VorpX injection driver  
**Last Verified:** 2026-03-19  

---

## The First Time You See Dunwall From Inside
...
Dishonored also supports **DirectVR scanning**, which automatically configures FOV, camera height, and other parameters to match your headset. What would normally require manual tweaking per-game is handled automatically. A 2020 VorpX update resolved earlier shadow bugs, making the experience more stable than in previous years.

The result: you launch the game, run a scan, and it mostly just works. By injection driver standards, this is about as plug-and-play as it gets.
...
Dishonored is one of the finest immersive sims of its generation. Outstanding level design, meaningful player agency, strong art direction, and excellent sound design combine into something genuinely special. The game stands on its own merits as a classic worth playing in any format. This rating is absolute—Dishonored is genuinely great regardless of how you play it.
...
Great game, terrible VR implementation, mid-tier experience. The atmosphere and design of Dishonored remain compelling, and seeing Dunwall from inside has genuine appeal—but the overall experience lands in C+ territory. You'd be better off playing a B-tier native VR game than this injection driver experience. The math is simple: A- game quality multiplied by D VR implementation equals C+ overall. If you're a Dishonored superfan with VorpX already and tolerance for gamepad-only play, go for it. But don't expect a VR experience worth choosing over actual VR games.
...
**The tier is C+, not B+.** Great game, weak VR implementation. A VR gamer deciding between this and, say, *Half-Life: Alyx* (native VR, S-tier), *MotherVR for Alien: Isolation* (community mod, B-tier), or even a B-tier native VR indie game should choose any of those over Dishonored via VorpX. Injection drivers are not equal to native VR or community mods. They're a compromise—a way to stand inside a flat game, not a way to truly *play it in VR*.
...
**Setup Friction:** Moderate. Requires some configuration—compatibility mode settings, shadow adjustments via INI edit, FOV and zoom calibration. Not difficult for experienced PC users, but not one-click either.

**Performance:** G3D renders the scene twice (one per eye), so expect roughly 50% framerate reduction versus flat play. Potato systems may struggle. Mid-range and above should handle Dishonored 1 comfortably in stereo. The game's age works in its favor—most systems can maintain playable framerates.

**Key Adjustments:** Dynamic shadows disabled (prevents artifacts), FOV set appropriately, image zoom calibrated for natural height perception. DirectVR scan handles most calibration automatically.

---

*Article by Ian  
For the Flat-to-VR Mod Project*