...
| **Supported Games** | 250+ official profiles (G3D), many more work with Z3D or cinema mode |
| **Render Modes** | Geometry 3D (true stereo), Z-Buffer 3D (depth-based), Cinema (virtual screen) |
| **Head Tracking** | Yes, all modes |
| **Motion Controls** | No (controller mapping only) |
| **VR Runtimes** | SteamVR, Oculus, OpenXR |
| **Headsets** | PCVR headsets (Quest via AirLink/Link works) |
| **DirectVR** | Auto-configuration for 150+ games |
| **Performance Impact** | ~50% framerate reduction in G3D, minimal in Z3D |
| **Refund Policy** | Limited/non-existent |
