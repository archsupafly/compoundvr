...
The [Witcher 3 HD Reworked Project](https://www.nexusmods.com/witcher3/mods/1021) by Halk Hogan is the single most important visual mod for VR, and it's not close. In flat play, you might not notice muddy ground textures or low-poly architecture at typical monitor viewing distances. In VR, where you can lean in and look at things, every texture deficiency is magnified.
...
- **[Super Turbo Lighting MOD](https://www.nexusmods.com/witcher3/mods/657)** (v3.2) pushes contrast and atmosphere harder. Night scenes feel darker. Interiors have more pronounced shadows. It's dramatic and cinematic, which reads well in VR where depth perception makes lighting matter more.
- **[Immersive Lighting](https://www.nexusmods.com/witcher3/mods/3953)** is the subtler alternative. It adjusts the same systems with a lighter hand, favoring consistency over drama.
...
When a drowner is two meters from your face in first-person VR, you want it to have a face. [HDMR](https://www.nexusmods.com/witcher3/mods/3580) rebuilds monster meshes and textures from scratch while keeping the vanilla design intent. The improvement is most noticeable in first-person combat encounters, where VR proximity makes low-resolution creature textures look like smeared paint.

**Install it.** Especially if you're running first-person mode.

## Characters Reworked

Same logic as HDMR, applied to humans. Dialogue scenes in VR put you face-to-face with NPCs at distances that the vanilla textures were never designed for. [Characters Reworked](https://www.nexusmods.com/witcher3/mods/7840) sharpens facial detail and clothing textures enough to survive the close scrutiny of headset viewing.
...
1. **[Gervant First Person](https://www.nexusmods.com/witcher3/mods/5706)** — spatial presence
2. **[HD Reworked Project](https://www.nexusmods.com/witcher3/mods/1021)** — texture sharpness
3. **[HDMR](https://www.nexusmods.com/witcher3/mods/3580) + [Characters Reworked](https://www.nexusmods.com/witcher3/mods/7840)** — close-range detail
4. **[Lighting mod](https://www.nexusmods.com/witcher3/mods/657)** — atmospheric depth
