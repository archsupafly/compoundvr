...
**Serious Sam: First & Second Encounter** — The cleanest entries on this whole list by route: official Serious Sam VR ports exist, built as real VR editions rather than community mods. If you want 2000s shooting with none of the setup burden, this is the easy win.

**Garry's Mod** — The GMod VR mod exists and lets you step inside the sandbox, which is chaos in the best way when the physics toys are in your hands. Mature enough to be worth a look, rougher than a native build.
...
**Mirror's Edge (2008)** — The mirrors-edge-vr-mod landed in August 2026 alongside the game's historic Rift support, and the first-person parkour of Faith's rooftop runs is a strong VR fit when the movement is in your hands. New, but the concept was VR-shaped before VR existed.

**Dead Space (2008)** — The chortdev trilogy VR mod is in progress as of mid-2026, early and incomplete, so treat it as a project to track rather than a game to play tonight. The original's "cut off the limbs" horror is a perfect VR premise; the mod is not there yet.

**The Elder Scrolls IV: Oblivion (2006)** — Be precise here: the VR route is UEVR running on the Oblivion Remastered from 2025, built in Unreal Engine 5, not the 2006 original. The 2006 game does not run in VR. If you want Cyrodiil in a headset, you buy and mod the Remastered, and the result is a modern-looking province worth the setup.

**F-Zero GX, Wind Waker, Super Mario Sunshine, Galaxy, Mario Kart Wii, Double Dash, Star Fox Adventures, Skies of Arcadia Legends, Eternal Darkness, Rogue Leader, TimeSplitters, Umbrella Chronicles, Dead Space: Extraction** — The Dolphin VR family, emulated GameCube and Wii titles with head-tracking treatment. Per-game depth varies wildly: racing and flight entries like F-Zero GX and the Star Fox titles need honest handling because emulated controls and camera behavior are uneven, while the exploration games fare better. All are name-checks here, not endorsements of equal quality.

**Wipeout Pure** — PPSSPP VR puts the PSP racer in a headset, and the sense of speed in a tube of neon is exactly what the series does best. A solid emulated pick for arcade-racing fans.
