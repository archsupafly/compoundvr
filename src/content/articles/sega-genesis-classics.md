...
1. Launch SteamVR (or your VR runtime)
2. Start Sega Genesis Classics from your Steam library
3. Select "Game Hub" mode (not "Simple Launcher")
4. The game should automatically detect your VR headset
5. You'll be placed in the virtual bedroom
...
**The Problem:**
VR controllers (Touch, Index, Vive wands) often don't work properly for menu navigation. The game was designed primarily for gamepad input, and VR controller support is essentially "emulated gamepad" mapping that doesn't always register correctly.

**The Workaround:**
Most users report needing to:
1. Enable "Steam Input" in controller settings
2. Use a physical Xbox/PlayStation gamepad as Player 1
3. Disable VR controller input or set it to secondary
4. Alt-tab to ensure the game window is focused
...
- [VorpX: The Honest Guide to VR Injection Drivers](/articles/vorpx-injection-driver-guide/)
- [3DSen VR: NES Emulation in VR](/articles/3dsen-vr/)
- [Welcome to CompoundVR](/articles/welcome-to-compoundvr/)
