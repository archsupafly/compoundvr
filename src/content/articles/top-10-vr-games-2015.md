...
**Team Fortress 2** has official VR support from Valve dating back to 2013, making it one of the first games to get a VR mode. It works. It's novel. It's also TF2 — a competitive multiplayer shooter where VR players are at a genuine disadvantage against mouse-and-keyboard opponents. Fun to try, not to live in. [Read the full TF2 VR review](/games/team-fortress-2)

**Dirt Rally** has VR support that's technically available and genuinely impressive when it runs well. Like Project CARS, the issue is consistency — performance and stability vary wildly. This could mature into one of the best VR racing experiences, but right now it's still finding its footing. [Read the full Dirt Rally VR review](/games/dirt-rally)

**Doom 3 BFG** has the beginnings of VR mod support through community efforts. Right now it's promising but rough — watch this space. [Read the full Doom 3 BFG VR review](/games/doom-3-bfg)

**Lucky's Tale** is the flagship Oculus platformer — a charming, polished 3D platformer proving VR can work for third-person games. It ships with every Rift CV1 preorder. It's delightful and forgettable in equal measure, which is why it's here instead of in the top 10. [Read the full Lucky's Tale VR review](/games/luckys-tale)

**DCS World** has VR support running on Oculus DK2, and it's already the most realistic combat flight sim you can experience in VR. The barrier to entry — HOTAS hardware, complex keybinds, a learning curve measured in weeks — keeps it out of the top 10, but for hardcore sim enthusiasts, it's the real deal. [Read the full DCS World VR review](/games/dcs-world)

**Windlands** is one of the first VR games making swinging through a world feel genuinely exhilarating. The grappling hook movement system produces moments of pure joy that few VR experiences can match. Motion sickness and limited content keep it out of the main list, but the core mechanic feels ahead of its time. [Read the full Windlands VR review](/games/windlands)
