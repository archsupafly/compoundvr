...
experienceTags:
  ...
  - Gamepad Required
tier: D
verdict: "Psychonauts is one of the best platformers ever made, but its VR option is so compromised that you're better off playing the official VR spinoff or using UEVR with the sequel."
heroImage: /images/games/psychonauts-vr-hero.jpg
sources: "VorpX official forums (Psychonauts profile page), VorpX supported games list, YouTube VR gameplay footage, Wikipedia (Psychonauts, Psychonauts in the Rhombus of Ruin), Nexus Mods and GameBanana (mod repository checks), PCGamingWiki (engine documentation), Steam Community discussions, Reddit community reports (r/virtualreality, r/PsychonautsGame), Flat2VR Discord community knowledge, praydog/UEVR GitHub documentation."
---
