...
routeType: Native VR
platforms: ['PSVR', 'PCVR']
flatReleaseDate: "2020-05-21"
vrReleaseDate: "2018-07-24"
...
experienceTags:
  ...
  - "Dark"
tier: "B"
verdict: "A genuinely strong roguelike horror game that was built for VR first, but the PCVR port's refusal to support motion controllers keeps it from feeling at home on modern PC headsets. On PSVR, it's one of the better seated horror experiences available."
heroImage: "/images/games/the-persistence-vr-hero.jpg"
sources: "Research conducted via UploadVR, Eurogamer, Push Square, ThisGenGaming, Nook Gaming, Steam Community discussions, Reddit PSVR community reports, Firesprite official game page, and YouTube VR gameplay footage (UploadVR, Paradise's Decay). Assessment based on published reviews and community experience; no direct testing performed."
---
