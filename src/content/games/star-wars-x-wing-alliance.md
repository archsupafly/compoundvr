...
experienceTags:
  ...
  - Space Sim
tier: B
verdict: "A substantial campaign experience with genuine cockpit presence and modern visual polish. Complex setup and demanding performance make this enthusiasts-only territory, but for patient Star Wars fans with HOTAS hardware, this is one of the most complete space sim campaigns available in VR."
...
**Installation layers:**
1. Clean X-Wing Alliance installation
2. XWAU Upgrade package (substantial download with modern assets)
3. VR configuration through the project's tools
4. SteamVR setup and tuning
