---
title: "The Walking Dead: Onslaught VR"
...
experienceTags:
  ...
  - Arcade Action
tier: D
verdict: "A native VR zombie shooter that works from start to finish but offers so little depth, interactivity, and design coherence that even fans of the AMC show will struggle to justify the time."
heroImage: /images/games/the-walking-dead-onslaught-vr-hero.jpg
sources: "Research compiled from Steam store page and user reviews, UploadVR review (David Jagneaux, 2020), IGN review (Gabriel Moss, 2020), and community reports across r/PSVR and r/Vive. Assessment based on multi-source research compilation rather than direct testing."
---
