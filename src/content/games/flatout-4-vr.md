...
experienceTags:
  ...
  - Stunt Mode
tier: "B"
verdict: "FlatOut 4 VR delivers exactly what the name promises: total insanity from a first-person cockpit. The official port is polished and functional, but the intensity is no joke—this is a ride for VR veterans with strong stomachs, not first-timers."
heroImage: /images/games/flatout-4-vr-hero.jpg
sources: "Research conducted via Steam store page, UploadVR impressions article (May 2026), Flat2VR Studios developer information, and community knowledge from Flat2VR Discord and Reddit r/virtualreality."
---
