...
experienceTags:
  ...
  - casual-gaming
tier: C
verdict: "A legendary game trapped inside a defunct VR wrapper. The platforming masterpiece is intact, but the VR layer adds atmosphere without adding interaction — and you can't buy it anymore."
heroImage: /images/games/sonic-the-hedgehog-3-knuckles-vr-hero.jpg
...
**Game Quality: S**
Sonic the Hedgehog 3 & Knuckles is a masterpiece of 2D platforming — tight controls, brilliant level design, iconic music, and the full lock-on experience remains one of the best games ever made.

**VR Implementation Quality: D**
The VR is a themed menu screen, not a VR adaptation of the game. You stand in a room and look at a flat TV. The bedroom environment is well-crafted, but it contributes nothing to the actual gameplay. This is VR as display case, not VR as experience.
