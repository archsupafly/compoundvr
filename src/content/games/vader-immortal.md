...
experienceTags:
  ...
  - Story-Driven
tier: A
verdict: "Vader Immortal is the Star Wars fantasy VR was built for — face-to-face with Vader, a humming lightsaber in your hand, production values that feel first-party. It's a short, complete experience rather than a deep game, and the Lightsaber Dojo gives it legs. One of the best things to put in front of anyone new to VR, and a joy even for veterans."
vrReleaseDate: 2019-05-21
heroImage: /images/games/vader-immortal-vr-hero.jpg
sources: "Research conducted via ILMxLAB official announcements, Oculus Store documentation, YouTube VR gameplay footage (Nathie, VR Grid, Gamertag VR), and media coverage from 2019 launch window (The Verge, Polygon, Road to VR). Assessment based on community experience and documented features; no direct testing performed."
---
...
Comfort is handled sensibly. Movement is node-based, shifting you between fixed positions rather than subjecting you to smooth locomotion through volcanic corridors. You spend most of your time standing in place or making small physical shifts. For a medium that still struggles with user comfort, that makes *Vader Immortal* one of the few high-quality VR experiences you can hand a brand-new headset owner without a second thought — it is the natural first thing to show someone to prove what this hardware is for. Performance on Quest is locked and stable; on Rift, the visual fidelity increases but the framerate stays consistent. ILMxLAB optimized for the hardware rather than pushing beyond it.

The catch is length and structure. Episode I is the first of three planned installments, and it ends before the narrative reaches any real resolution. What you get is a prologue — a well-made prologue, but a prologue nonetheless. The Lightsaber Dojo extends the value, yet the core story is a short, cinematic ride. The price asks you to pay for production value rather than volume. That tradeoff is legitimate, and knowing you are buying a high-end theme park attraction rather than a full campaign is what makes the price feel fair.

For Star Wars fans, the calculation is easy. Standing in a room with Darth Vader, hearing that voice from the correct spatial position, and holding a lightsaber that hums in your hand is a fantasy the flat screen cannot replicate. For Quest owners looking for a flagship exclusive that is not another wave shooter or stationary gallery, this is a polished, accessible showcase. And because it asks so little of the player while delivering that much spectacle, it is also the ideal first experience to hand someone who has never worn a headset — few polished titles make the case for VR as cleanly.

None of that means it is for everyone without a thought. If you do not carry nostalgia for the franchise, the rails feel tighter and the limited agency becomes more obvious — this is a guided tour, not a sandbox. And if you are waiting for a substantial VR action game, the sixty-minute story is the one thing to know: it is a short, cinematic ride rather than a campaign. The Lightsaber Dojo and the production values are what make those minutes worth the price, and for most players they do.

*Vader Immortal* is a statement of intent from ILMxLAB. It proves that Star Wars in VR can look, sound, and feel like a first-party production when the studio building it understands the hardware. The Lightsaber Dojo gives it purpose beyond the credits, but the heart of the package is cinematic presence — standing close enough to a Sith Lord to feel the temperature drop. It is not a deep game, and it was never meant to be. It is the Star Wars fantasy VR exists to deliver: short, complete, and good enough that almost anyone who puts it on will come away glad they did.
