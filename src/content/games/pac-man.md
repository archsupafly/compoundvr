...
routes:
  - name: 3dSen VR
    ...
    status: Recommended
    platforms: ['PCVR', 'Quest']
    notes: "NES Pac-Man with real-time 2D-to-3D voxel transformation. Motion controller support. $24.99 + ROM. Best for authentic NES gameplay."
  - name: EmuVR
    type: Emulator / Environment
    status: Recommended
    platforms: ['PCVR']
    notes: "Play arcade Pac-Man on virtual CRT or arcade cabinet in a customizable retro room. Free + ROMs. Best for atmosphere and arcade authenticity."
  - name: Oculus Arcade
    type: Official Historical
    status: Discontinued
    platforms: ['Quest']
    notes: "Official 2015 Meta release. 21-game compilation including Pac-Man. Played on virtual CRT in arcade environment. No longer available on store."
  - name: Pac-Man VR (1996)
    type: Official Historical
    status: Inaccessible
    platforms: ['Arcade']
    notes: "Rare 1996 Virtuality arcade hardware. ROM was found in 2020 but cannot be emulated on modern VR headsets. Historical curiosity only."
  - name: Unofficial Clones
    type: Native VR
    status: Research
    platforms: ['Quest', 'PCVR']
    notes: "Various itch.io and WebVR implementations including NipsApp Pac-Man VR. Not licensed by Namco. Quality varies significantly."
---
...
| Route | Type | Platforms | Price | Authentic | Availability |
|-------|------|-----------|-------|-----------|--------------|
| 3dSen VR | NES Emulator | PCVR, Quest via Link | $24.99 + ROM | NES version | Available |
| EmuVR | Arcade Emulator | PCVR | Free + ROM | Arcade original | Available |
| Oculus Arcade | Official Arcade | Quest | N/A (discontinued) | Arcade original | Unavailable |
| Pac-Man VR (1996) | Official Arcade | Arcade hardware only | Inaccessible | Original | Inaccessible |
| Clones | Native VR | Varies | Varies | No | Varies |
...
| **Playability** | 4/5 — Full game accessible, NES version differences |
| **Controls** | 3/5 — Motion controller functional, precision varies |
| **Comfort** | 5/5 — Static viewpoint, no locomotion |
| **Performance** | 5/5 — Lightweight, runs on modest hardware |
| **Stability** | 4/5 — Mature emulator, solid reliability |

## Scoring (EmuVR Route)

| Category | Score |
|----------|-------|
| **Setup Friction** | 3/5 — More complex initial configuration |
| **VR Implementation** | 4/5 — Excellent environment immersion |
| **Playability** | 4/5 — Full arcade game, authentic code |
| **Controls** | 3/5 — Depends on configuration |
| **Comfort** | 5/5 — Static viewpoint, room-scale optional |
| **Performance** | 4/5 — Modest demands, heavier than 3dSen |
| **Stability** | 4/5 — Beta software, occasional quirks |
