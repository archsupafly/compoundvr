...
tier: B
verdict: "A genuinely impressive official port that puts one of the biggest RPG worlds inside a headset, but it demands a high-end PC, tolerance for janky Vive-wand controls, and a willingness to mod around missing DLC and lingering rough edges."
heroImage: /images/games/fallout-4-vr-hero.jpg
sources: "Research conducted via Bethesda/Steam store pages, IGN, PCWorld, UploadVR, Gaming Trend, Road to VR, GamingBolt patch notes, Nexus Mods, Steam Community, and Reddit. No direct testing performed."
---
...
Bethesda didn't just dip a toe into VR here. They ported the entire base game — the whole absurdly large open world, the main quest, the factions, the settlements, the crafting, the power armor, the radiation storms. This isn't a demo or a stripped-down side mode. It's Fallout 4, in a headset, with motion controllers. That alone made it one of the most ambitious VR releases of 2017, and the fact that it works at all still feels faintly miraculous. The fact that it works *well* takes some help.
...
This is not a game I would recommend blindly. If you want polished, curated VR, there are dozens of better options. If you want to spend a hundred hours inside a real RPG world, moving and shooting and building settlements with your own hands, Fallout 4 VR is one of the few games that delivers it — but only if you meet it halfway. Get a powerful PC. Install the community fixes. Make peace with the Vive-wand compromises. Accept that Bethesda patched it into viability and then moved on.

For Fallout fans with the hardware and the patience, this is still one of the most compelling reasons to own a PCVR headset. For everyone else, the flat version is right there, cheaper and less likely to make you accidentally set a friendly NPC on fire.
