...
experienceTags:
  ...
  - Cinematic
tier: A
verdict: "A substantial WWII VR shooter with satisfying weapon handling and a unique documentary gallery — ten hours of campaign that delivers despite episodic pacing and inconsistent AI. The dead multiplayer stings, but on PCVR this is the best WWII VR shooting you can buy."
heroImage: /images/games/medal-of-honor-above-and-beyond-vr-hero.jpg
sources: "Research compiled from UploadVR reviews and graphics comparisons (David Jagneaux, Jamie Feltham), The VR Grid PC and Quest reviews (Ryan Ouellette), Meta Quest store page documentation, Road to VR and Mixed News multiplayer shutdown coverage, UploadVR multiplayer closure article, Steam community discussions, Reddit community reports (r/OculusQuest, r/SteamVR), and YouTube VR gameplay footage (The VR Grid, UploadVR). No direct testing performed."
---
...
So who should bother? If you want a lengthy, scripted WWII shooter with excellent weapon handling, this is the best one VR has — full stop. The pacing is fragmented and the AI occasionally embarrasses itself, but neither kills what the good stretches deliver. History buffs should absolutely see the Gallery — it's the only place in VR where you'll find WWII veterans telling their own stories. Multiplayer seekers should look elsewhere entirely — the servers are dead and nothing is coming back. And if you are sensitive to smooth locomotion or need teleportation, this is not the shooter for you.

*Medal of Honor: Above and Beyond* is proof that AAA resources, pointed at VR, can produce something genuinely worth the headset time. Ten hours of campaign, weapon handling that still feels great years later, and a documentary Gallery no other shooter offers — all native, all in the headset. It is not perfect: the scene-by-scene pacing frays at the edges, the AI is inconsistent, and the multiplayer is gone. But on PCVR, this is an A-tier experience for shooter fans — the Quest port's compromises are simply the hardware talking. Play it, and point the history buffs at the Gallery.
