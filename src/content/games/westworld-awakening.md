...
# Westworld Awakening in VR: A Host Wakes Up, and It Gets Uncomfortable Fast
...
*Westworld Awakening* is a single-player, PCVR-only narrative adventure set during the early events of Westworld Season 2. You play Kate, a Host who gains self-awareness and has to sneak through the Delos facility while another Host named Hank hunts her down. It launched on August 20, 2019, for SteamVR, Oculus Rift, and HTC Vive, with a simultaneous VR arcade release.

There is no flatscreen version. There is no Quest version. There is no UEVR profile or VorpX injection to hunt down — the game is already native VR with full motion controls. That makes the setup dead simple, but it also means the addressable audience is narrow: you need a PCVR headset and a tolerance for short, linear horror.
...
The atmosphere is the star. The Delos facility feels sterile and threatening in exactly the right way, and the game is unafraid to make you feel small, watched, and used. The opening chapter — where you're still inside the park's scripted narrative and a "hero" character leers at you — is genuinely skin-crawling in a way that only works because you're wearing a headset.

The license isn't just window dressing. The themes of loops, memory, and awakening map directly onto the mechanics. You're not playing a Westworld-themed escape room; you're experiencing the show's premise from the inside. That gives the game's short runtime more impact than its length suggests.

Performance is reasonable on mid-range hardware from its era. As a 2019 PCVR title built around tight interiors rather than open environments, it runs well enough that you don't have to think about frame timing while you're trying not to get caught.

## What Holds It Back

Length is the clearest limitation. My first playthrough clocked in around three hours, and while the developers suggested four to six hours for completionists hunting secrets, that's still a single-evening experience. For a narrative game with little replay value, that's a tough value proposition at full price.
