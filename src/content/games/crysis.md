...
experienceTags:
  ...
  - Superpowers
tier: S
verdict: "The fholger VR mod turns one of the most influential FPS campaigns ever made into a stunning room-scale experience. Full motion controls, smart nanosuit integration, and the same developer behind the Half-Life 2 VR mod — this is flat-to-VR conversion at its best. Performance demands are real and the mod isn't flawless, but standing on that beach in the nanosuit for the first time is one of VR's great moments."
...
That changed in early 2025, and the answer is better than anyone expected.
...
Community reports describe performance as demanding on mid-range hardware, though a modern high-end system handles it well. A high-end CPU is recommended—Ryzen 7000 series or Intel 12th-gen and newer appear to be the threshold for a consistently smooth experience. This is not a game you casually fire up on a headset connected to a laptop, but it's also not the insurmountable barrier the meme suggests.
...
**VorpX note:** If you own Crysis Remastered (which the fholger mod doesn't support) or your hardware genuinely can't handle the full mod, VorpX provides a basic injection option with stereoscopic 3D and head tracking but no motion controls. Crysis Warhead in particular runs well through it. But given that a full VR mod exists, there's little reason to settle for injection unless you have no other choice.

## Who Should Actually Play This

The fholger mod is for anyone who wants to experience one of the most influential FPS campaigns ever made from inside the nanosuit. If you have the hardware to run it and you own the original game on Steam or GOG, the setup is straightforward: download the installer from GitHub, point it at your game directory, and launch. The mod handles dependencies automatically.

The mod isn't perfect — Crysis is an 18-year-old game with 18-year-old design sensibilities, and some vehicle sections were never designed with VR comfort in mind. But fholger's track record (Half-Life 2 VR) speaks for itself, and the active development through 2025 with multiple stability and control updates shows commitment. The OpenXR foundation means Oculus and Windows Mixed Reality users can run it through native runtimes without forcing everything through SteamVR.

Crysis in VR was a joke for years. It isn't anymore. Standing on that beach in the nanosuit for the first time — looking down at your virtual hands, watching the jungle stretch to the horizon in stereoscopic depth, physically grabbing your rifle from your back — is one of VR's great moments. The hardware still needs to answer that old question in the affirmative. But if it can, this is essential.