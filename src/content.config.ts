...
const games = defineCollection({
  ...
  schema: z.object({
    ...
    featured: z.boolean().default(false),
    routeType: z.enum(['Official Hybrid', 'Official Standalone VR Version', 'Full VR Mod', 'Framework-Based', 'Injection Driver', 'Multi-Route Coverage', 'Emulator']),
    ...
    tier: z.enum(['S', 'A', 'B+', 'B', 'C', 'D', 'F']).optional(),
    verdict: z.string(),
    heroImage: z.string().optional(),
